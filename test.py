...
def make_block_3conv(layers, in_channels, out_channels, kernel_size=3, stride=1, padding=1):
...
class Colorizer(nn.Module):
    def __init__(self):
        ...
        make_block_2conv(self.layers, 32, 128)
        make_block_3conv(self.layers, 128, 256, 3, stride=2)
        make_block_3conv(self.layers, 256, 512, 3, stride=2)
        make_block_3conv(self.layers, 512, 512, 3, stride=2)
